<template>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <input type="text" id="login" class="fadeIn second" v-model="email"  placeholder="enter email">
            <input type="password" id="password" class="fadeIn third" v-model="password" placeholder="password">
            <input type="submit" class="fadeIn fourth" value="Login" @click="login">
            

            <!-- Remind Passowrd -->
            <div id="formFooter">
            <p>if you have no Account? <router-link to="/SignUp" >SignUp</router-link>
            </p>
            </div>
...
//    this.$store.dispatch(AUTH_REQUEST, { useremailname, password }).then(() => {
